...
export const StaticStaffingMap = ({ destinationStats }: StaticStaffingMapProps) => {
  ...
  return (
    <div className="relative w-full h-full">
      <img src={mapImage} alt="North America Map" className="w-full h-full object-cover rounded-lg" />
        ...
        return (
          <div key={stat.destination.id} className="absolute" style={{ left: position.x, top: position.y }}>
            ...
            <button
              ...
              onClick={() =>
                setSelectedDestination(selectedDestination === stat.destination.id ? null : stat.destination.id)
              }
